...
def main():
    ...
    res = FeaturesEndSegmentLevel.EOSPunctuation("Michael Jackson likes to eat at McDonalds.")
    if res == 0:
    ...
    res = FeaturesEndSegmentLevel.EOSPunctuation("I like to eat at McDonalds")
    if res == 0:
    ...
    res = FeaturesEndSegmentLevel.EOSPunctuation("NBA players are tall,")
    if res == 0:
